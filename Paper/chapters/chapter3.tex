...
\begin{center}
	...
	\centerline{\captionof{Figure 3.2: }{Data distribution by number of samples.}}
\label{dd}
\end{center}
...
\begin{center}
	...
	\centerline{\captionof{Figure 3.3: }{Model loss before adding Convolutional Operations to the Model}}
\label{bad_metrics}
\end{center}
...
\begin{center}
	...
	\centerline{\captionof{Figure 3.4: }{Model accuracy before adding Convolutional Operations to the Model}}
\label{bad_metrics2}
\end{center}
...
\begin{center}
	...
	\centerline{\captionof{Figure 3.5: }{The model loss after incorporating Convolutional Layers}}
\label{good_metrics}
\end{center}
...
\begin{center}
	...
	\centerline{\captionof{Figure 3.6: }{The model accuracy after incorporating Convolutional Layers}}
\label{good_metrics2}
\end{center}
...
\begin{center}
 ...
 \centerline{\captionof{Figure 3.7: }{Data flow throughout the model (image source \cite{fwbw})}}
\label{data_flow}
\end{center}
...
\begin{center}
	...
	\centerline{\captionof{Figure 3.8: Generic Convolutional Neural Network architecture (image source \cite{cnna})}}
\label{genarch}
\end{center}
...
\begin{figure}[H]
	...
	\centerline{\captionof{Figure 3.9: User input handling pipeline}}
\label{mo}
\end{figure}
	...
	\item Audio file cleaning: Given the reason that the model was trained on 1 second snippets of audio files of sample rate of 16000,
		...
		\begin{itemize}
			...
			\begin{figure}[H]
				...
				\centerline{\captionof{Figure 3.10: Sound envelope example (Source \cite{sev})}}
			\label{se}
			\end{figure}
...
\item Loading the random sound samples into the model: The Neural Network Engine also presents the \textit{inference}
	...
	\begin{itemize}
		...
		over time,called spectrum. \cite{ft}
			...
			\centerline{\captionof{Figure 3.11: Fourier transformation (Source \cite{ft})}}
			\label{ft}
			\end{figure}
		...
		\item MEL Filterbank transformation
			...
			\begin{figure}[H]
				...
				\centerline{\captionof{Figure 3.12: MEL Spectogram example}}
			\label{ms}
			\end{figure}
...
\section{The Application-User Interaction}
	...
	The following figure illustrates some of the application states.
			...
			\begin{center}
				...
				\centerline{\captionof{Figure 3.13: The Graphic User Interface at the start of the application.}}
			\label{guis}
			\end{center}
			...
			\centerline{\captionof{Figure 3.14: The Graphic User Interface after predicting a song as a piano song.}}
			\label{guip}
			\end{center}

			\begin{center}
				\centering
				\includegraphics[width = 5.0in]{images/other.png}
				\centerline{\captionof{Figure 3.15: The Graphic User Interface after classifying a song as other.}}
			\label{guio}
			\end{center}
