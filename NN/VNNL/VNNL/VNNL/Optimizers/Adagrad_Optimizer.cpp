...
Adagrad_Optimizer::Adagrad_Optimizer(double learning_rate , double decay , double epsilon )
{
...
void Adagrad_Optimizer::Update_Params(Layer_Type layer_type)
{
    ...
    l.weights_cache += xt::square(l.derivated_weights);
    l.bias_cache += xt::square(l.derivated_biases);
